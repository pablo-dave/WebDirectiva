...
<header style="background: #1A1501;" class="main_menu_sec navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12">
                <div class=".lft_hd">
                    <a href="{{url('/')}}"><img style="position:absolute;" src="{{asset('img/logo.png')}}" width="220px" height="60px"  alt=""/></a>
                </div>
            </div>          
                    ...
                    <div class="main_menu">
                        ...
                        <div id="navbar">
                            ...
                            <ul>
                                ...
                                <li><a class="page-scroll" href="#abt_sec">Conócenos</a></li>
                                <li><a class="page-scroll" href="#skill_sec">Habilidades</a></li>
                                <li><a class="page-scroll" href="#pr_sec">Servicios</a></li>
                                <li><a class="page-scroll" href="#protfolio_sec">Portafolio</a></li>
                                <li><a class="page-scroll" href="#ctn_sec">Contáctanos</a></li>
                            </ul>
                        </div>      
                        </nav>          
                    </div>                  
                    ...
                    <div class="item">
                        <div class="wrap_caption">
                          <div class="caption_carousel">
                            ...
                            <p>ESTAMOS SIEMPRE ACORDE A LAS NUEVAS TECNOLOGÍAS Y MEJORAMOS NUESTROS DESARROLLOS</p>
                          </div>                        
                        </div>
                    </div>                  
                    <div class="item ">
                        <div class="wrap_caption">
                          <div class="caption_carousel">
                            ...
                            <p>NUESTRO EQUIPO ESPECIALIZADO TE AYUDARÁ A OBTENER LO MEJOR EN EL DESARROLLO DE TUS SISTEMAS</p>
                          </div>                        
                        </div>
                    </div>          
                  </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs12 ">
                <div class="title_sec">
                    <h1>Conócenos</h1>
                    <h2>NUESTRAS HABILIDADES SE ENFOCAN EN EL CLIENTE..</h2>
                </div>          
            </div>      
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs12 ">
                <div class="abt">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs12 ">
                <div class="title_sec">
                    ...
                    <h2>OFRECEMOS SERVICIOS DE ALTA CALIDAD Y ACORDE A LAS NECESIDADES DEL CLIENTE</h2>
                </div>          
            </div>      
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="service">                       
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs12 ">
                <div class="title_sec">
                    ...
                    <h2>LO MAS IMPORTANTE ES QUE SE AJUSTE A TUS REQUERIMIENTOS, TE PRESENTAMOS NUESTRO PORTAFOLIO</h2>
                </div>          
            </div>      
            <div class="col-lg-12">
                ...
                <li data-filter=".web-design">Desarrollo Web</li>
                <li data-filter=".graphic">Sistemas de Escritorio</li>
                <li data-filter=".photography">Sistemas Web</li>
                <li data-filter=".motion-video">Aplicaciones Móviles</li>
                </ul>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="clnt_tstm">
                    <div class="sngl_tstm">
                        <i class="fa fa-quote-right"></i>
                        <h3>Awesome Support DIRECTIVA</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur sequi accusamus voluptatum rem itaque alias deleniti nostrum aperiam fugiat voluptates debitis praesentium incidunt accusantium distinctio,</p>
                        <h6>- kumara deo</h6>                   
                    </div>
                </div>              
...
<script src="{{asset('js/showHide.js')}}" type="text/javascript"></script>
